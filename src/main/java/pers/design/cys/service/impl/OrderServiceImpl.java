...
import pers.design.cys.converter.OrderMaster2OrderDTOConverter;
...
import pers.design.cys.repository.OrderDetailRepository;
import pers.design.cys.repository.OrderMasterRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public Page<OrderDTO> findListByUsername(String username, Pageable pageable) {

        Page<OrderMaster> orderMasterPage = orderMasterRepository.findByUsername(username, pageable);
